...
export async function updateSession(request: NextRequest) {
  ...
  // Still allow public pages (landing, about, missing-db-config) to render so visitors
  // can see the site before the Supabase project is wired up.
  if (!supabaseUrl || !supabaseKey) {
    const publicPaths = ["/", "/about", "/missing-db-config"];
