  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        ...
        <p className="flex items-center justify-center gap-2 opacity-80 hover:opacity-100 transition-opacity flex-wrap">
          <span className="font-semibold text-stone-600">© Đỗ Phúc Tộc</span>
          <span className="text-stone-400">·</span>
          <span className="text-stone-500">forked from</span>
          <a
