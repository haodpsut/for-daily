      ...
      >
        ...
        >
          ...
          >
            ...
            Gia phả dòng họ — Cội nguồn & Hậu duệ
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-stone-600 max-w-2xl mx-auto leading-relaxed font-light">
            Gìn giữ cội nguồn, tri ân tiền nhân và lưu truyền truyền thống tốt
            đẹp của dòng họ <span className="font-semibold text-stone-700">Đỗ Phúc Tộc</span> cho các thế hệ mai sau.
          </p>
        </motion.div>
