...
import { createAnnivAction } from "@/lib/actions/anniversaries";

export const dynamic = "force-dynamic";

export default async function NewAnnivPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <h1 className="serif text-3xl font-bold text-stone-900">Thêm giỗ kỵ</h1>
      <div className="mt-8">
        <AnnivForm action={createAnnivAction} submitLabel="Tạo giỗ kỵ" persons={personList} />
      </div>
    </main>
  );
}
